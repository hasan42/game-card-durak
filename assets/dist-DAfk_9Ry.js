...
var dist_exports = /* @__PURE__ */ __exportAll({
	...
	default: () => src_bridge,
	parseURLSearchParamsForGetLaunchParams: () => parseURLSearchParamsForGetLaunchParams
});
...
var package_namespaceObject = { rE: "3.0.1" };
function applyMiddleware(...middlewares) {
	...
	return (bridge) => {
		...
		send = middlewares.filter((item) => "function" == typeof item).map((middleware) => middleware(middlewareAPI)).reduce((a, b) => (send) => a(b(send)))(bridge.send);
		return {
			...bridge,
			send
		};
...
var getLaunchParamsResponseLanguagesSet = new Set([
	"ru",
	"uk",
	"ua",
	"en",
...
var getLaunchParamsResponseGroupRoleSet = new Set([
	"admin",
	"editor",
	"member",
	"moder",
...
var getLaunchParamsResponsePlatformsSet = new Set([
	"desktop_web",
...
//#endregion
export { src_bridge as n, dist_exports as t };
